...
package kr.co.bitnine.octopus.maven.plugin.util;
...
public class Exec
{
    ...
    /**
     * Creates a new Exec instance for executing an external process
     * from the given mojo.
     *
    ...
    /**
     * Runs the specified command and saves each line of the command's output
     * to the given list.
     *
    ...
    private static class OutputBufferThread extends Thread
    {
        ...
        public void run()
        {
            try {
                ...
                throw new RuntimeException("read failed: " + e.toString());
            }
        }
