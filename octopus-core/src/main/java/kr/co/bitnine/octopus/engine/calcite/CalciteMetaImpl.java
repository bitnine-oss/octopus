 ...
 */
public final class CalciteMetaImpl extends MetaImpl {
    static final kr.co.bitnine.octopus.engine.calcite.Driver DRIVER = new Driver();
    ...
    public StatementHandle createStatement(ConnectionHandle ch) {
        ...
        calciteConnection.getServer().addStatement(calciteConnection, h);
        return h;
    }
    ...
    public void closeStatement(StatementHandle h) {
        ...
        calciteConnection.getServer().removeStatement(h);
    }
    ...
    Enumerable<MetaTable> tables(final MetaSchema metaSchema) {
        final CalciteMetaSchema schema = (CalciteMetaSchema) metaSchema;
    ...
    public Enumerable<MetaColumn> columns(final MetaTable metaTable) {
        final CalciteMetaTable table = (CalciteMetaTable) metaTable;
        final RelDataType rowType =
                table.calciteTable.getRowType(getConnection().getTypeFactory());
    ...
    Iterable<Object> createIterableImpl(StatementHandle handle,
                                     Signature signature, List<TypedValue> parameterValues, Frame firstFrame) {
        try {
            //noinspection unchecked
    ...
    public StatementHandle prepare(ConnectionHandle ch, String sql,
        ...
        CalciteServerStatement statement = calciteConnection.getServer().getStatement(h);
        h.signature =
        ...
        try {
            synchronized (callback.getMonitor()) {
                ...
                CalciteServerStatement statement =
                        calciteConnection.getServer().getStatement(h);
    ...
    public ExecuteResult execute(StatementHandle h,
        ...
        final Iterable<Object> iterable =
                createIterableImpl(h, signature, parameterValues, null);
        iterator = iterable.iterator();
        stmt.setResultSet(iterator);
