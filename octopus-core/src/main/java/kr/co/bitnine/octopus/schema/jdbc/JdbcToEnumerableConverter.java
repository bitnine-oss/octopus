 ...
 */
public final class JdbcToEnumerableConverter
    ...
    public Result implement(EnumerableRelImplementor implementor, Prefer pref) {
        ...
        String sql = generateSql(jdbcConvention.getDialect());
        if (CalcitePrepareImpl.DEBUG) {
            System.out.println("[" + sql + "]");
        }
        Hook.QUERY_PLAN.run(sql);
        final Expression sqlExpr =
        ...
        CalendarPolicy calendarPolicy = CalendarPolicy.of(jdbcConvention.getDialect());
        ...
        final ParameterExpression expr =
        ...
        final Expression enumerable =
                builder0.append(
                        ...
                        Expressions.call(
                                ...
                                Expressions.call(
                                        Schemas.unwrap(jdbcConvention.getExpression(),
                                                OctopusJdbcDataSource.class),
     ...
     * such as {@link ResultSet#getTimestamp(int, Calendar)}.
     */
