 ...
 */
public final class JavaTypeFactoryImpl
    ...
    public Type getJavaClass(RelDataType type) {
        ...
        case ROW:
            ...
            if (type instanceof JavaRecordType) {
                return ((JavaRecordType) type).getClazz();
            } else {
     ...
     */
    public static final class SyntheticRecordType implements Types.RecordType {
        private final List<Types.RecordField> fields = new ArrayList<>();
