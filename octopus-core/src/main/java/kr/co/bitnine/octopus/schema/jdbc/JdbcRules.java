...
public final class JdbcRules {
    ...
    private static void addSelect(
        ...
        if (alias == null || !alias.equals(name)) {
            added = SqlStdOperatorTable.AS.createCall(
     ...
     */
    private static final class JdbcJoinRule extends JdbcConverterRule {
     ...
     */
    public static final class JdbcJoin extends Join implements JdbcRel {
        protected JdbcJoin(
     ...
     */
    private static final class JdbcCalcRule extends JdbcConverterRule {
        ...
        public RelNode convert(RelNode rel) {
            ...
            return new JdbcCalc(rel.getCluster(), rel.getTraitSet().replace(getOut()),
                    convert(calc.getInput(), calc.getTraitSet().replace(getOut())),
                    calc.getProgram());
        }
    }
     ...
     */
    public static final class JdbcCalc extends SingleRel implements JdbcRel {
     ...
     */
    private static final class JdbcProjectRule extends JdbcConverterRule {
     ...
     */
    public static final class JdbcProject
            extends Project
            implements JdbcRel {
        public JdbcProject(
                RelOptCluster cluster,
        ...
        public JdbcImplementor.Result implement(JdbcImplementor implementor) {
            ...
            final List<SqlNode> selectList = new ArrayList<>();
            for (RexNode ref : exps) {
                SqlNode sqlExpr = builder.getContext().toSql(null, ref);
                addSelect(selectList, sqlExpr, getRowType());
            }
            builder.setSelect(new SqlNodeList(selectList, POS));
            return builder.result();
     ...
     */
    private static final class JdbcFilterRule extends JdbcConverterRule {
     ...
     * {@link JdbcConvention jdbc calling convention}.
     */
    public static final class JdbcFilter extends Filter implements JdbcRel {
        public JdbcFilter(
                RelOptCluster cluster,
                RelTraitSet traitSet,
                RelNode input,
        ...
        public JdbcImplementor.Result implement(JdbcImplementor implementor) {
            ...
            builder.setWhere(builder.getContext().toSql(null, condition));
            return builder.result();
        }
    }
     ...
     * to a {@link JdbcRules.JdbcAggregate}.
     */
    private static final class JdbcAggregateRule extends JdbcConverterRule {
        ...
        public RelNode convert(RelNode rel) {
            ...
            final RelTraitSet traitSet =
                    agg.getTraitSet().replace(getOut());
            try {
                return new JdbcAggregate(rel.getCluster(), traitSet,
                        convert(agg.getInput(), getOut()), agg.indicator, agg.getGroupSet(),
     ...
     */
    public static final class JdbcAggregate extends Aggregate implements JdbcRel {
     ...
     * {@link JdbcRules.JdbcSort}.
     */
    private static final class JdbcSortRule extends JdbcConverterRule {
     ...
     */
    public static final class JdbcSort
            extends Sort
            implements JdbcRel {
        public JdbcSort(
                RelOptCluster cluster,
        ...
        public JdbcImplementor.Result implement(JdbcImplementor implementor) {
            ...
            for (RelFieldCollation fieldCollation : collation.getFieldCollations()) {
                if (fieldCollation.nullDirection
                        ...
                        && implementor.getDialect().getDatabaseProduct()
                        == SqlDialect.DatabaseProduct.MYSQL) {
                    orderByList.add(
                            ISNULL_FUNCTION.createCall(POS,
                                    builder.getContext().field(fieldCollation.getFieldIndex())));
                    fieldCollation = new RelFieldCollation(fieldCollation.getFieldIndex(),
                            fieldCollation.getDirection());
                }
                orderByList.add(builder.getContext().toSql(fieldCollation));
            }
     ...
     * {@link JdbcRules.JdbcUnion}.
     */
    private static final class JdbcUnionRule extends JdbcConverterRule {
     ...
     */
    public static final class JdbcUnion extends Union implements JdbcRel {
        public JdbcUnion(
                RelOptCluster cluster,
                RelTraitSet traitSet,
                List<RelNode> inputs,
     ...
     * to a {@link JdbcRules.JdbcIntersect}.
     */
    private static final class JdbcIntersectRule extends JdbcConverterRule {
        ...
        public RelNode convert(RelNode rel) {
            ...
            final RelTraitSet traitSet =
                    intersect.getTraitSet().replace(getOut());
            return new JdbcIntersect(rel.getCluster(), traitSet,
                    convertList(intersect.getInputs(), getOut()), false);
        }
    }
     ...
     */
    public static final class JdbcIntersect
            extends Intersect
            implements JdbcRel {
     ...
     * {@link JdbcRules.JdbcMinus}.
     */
    private static final class JdbcMinusRule extends JdbcConverterRule {
        ...
        public RelNode convert(RelNode rel) {
            ...
            return new JdbcMinus(rel.getCluster(), traitSet,
                    convertList(minus.getInputs(), getOut()), false);
        }
    }
     ...
     */
    public static final class JdbcMinus extends Minus implements JdbcRel {
     ...
     */
    public static final class JdbcTableModificationRule extends JdbcConverterRule {
     ...
     */
    public static final class JdbcTableModify extends TableModify implements JdbcRel {
     ...
     */
    public static final class JdbcValuesRule extends JdbcConverterRule {
     ...
     */
    public static final class JdbcValues extends Values implements JdbcRel {
